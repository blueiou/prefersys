var dirapp=angular.module('mv.directive',[]);
dirapp.directive('treeView', ['$compile', '$templateCache', function ($compile, $templateCache) {
    return {
        restrict: 'E',
        scope: {},
        bindToController: {
        ...
        link: function (scope, element, attrs, ctrl) {
            ...
            var template =
                '<ul>' +
                    '<li ng-repeat="node in [REPLACENODES]" ui-sref="index"> ' +
