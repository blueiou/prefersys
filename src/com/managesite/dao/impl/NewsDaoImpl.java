...
public class NewsDaoImpl extends BaseDaoImpl<News>{
	...
	public Page getPageList(int pageno ,int pagesize,int temp){
		...
		String hql1="select new com.managesite.model.NewsModel(n.new_id,n.title,n.user.username,n.descript,n.creatTime,n.preImg) from News n where n.newsstatu.status='"+temp+"'";
