...
import com.managesite.entity.BaseInfo;
import com.managesite.entity.Goods;
import com.managesite.entity.Hall;
...
import com.managesite.tools.CheckId;
...
news.setType(types);
news.setUser(user);*/
/*NewsImg newsImg=new NewsImg("这是第三次次images\\movie\\2016021815030125.jpg","images\\movie\\2016021815030125.jpg");
newsImg.setNews(news);*/
/*user.setUsername("dayday");
